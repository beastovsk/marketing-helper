...
// import {useStore} from '../../modules/Marketplace/store';
import {useMutation} from 'react-query';
// import {ConfirmEmail, ResetPassword, SendResetCode} from '../../modules/Marketplace/api';
...
export const ResetPasswordModal = () => {
  ...
  return (
    ...
    //       <Btn className='mt-2 flex justify-center m-auto' htmlTypeButton='submit' loading={false}>
    //         Далее
    //       </Btn>
    //     </Form>
    //   ) : null}
